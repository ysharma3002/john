...
class innerCalendarState extends StatefulWidget {
  @override
  innerCalendar createState() => innerCalendar();
}

class innerCalendar extends State<innerCalendarState> {
    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text('Calendar', style: TextStyle(fontSize: 35, color: Colors.deepOrange,fontWeight: FontWeight.bold,),),
