...
import 'package:stableapp/intro.dart';
      ...
      body: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            child: Text('Pending Tasks', style: TextStyle(fontSize: 30,
              color: Colors.black,
              fontWeight: FontWeight.bold,),),
          ...
          Container(
            ...
            child: Text('Upcoming Events', style: TextStyle(fontSize: 30,
              color: Colors.black,
              fontWeight: FontWeight.bold,),),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      onPressed: () {
                        Navigator.push<Widget>(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                tasksClicked(
                                  image: pendingTasksOnClicked[index],
                                  name: pendingTasksName[index],
                                  description: pendingTasksDescription[index],
                                  url: pendingTasksURL[index],), // TODO: pass event name as well
                          ),
                        );
                      },
                    ...
                    Container(
                      ...
                      child: Text(pendingTasksName[index],
                    ...
                    new FlatButton(
                      ...
                      onPressed: () {
                        Navigator.push<Widget>(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                tasksClicked(image: eventsOnClicked[index],
                                  description: eventsDescription[index],
